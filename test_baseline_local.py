"""
Test Baseline Calculator Locally
Calculates baselines from BigQuery data and saves results locally
"""
...
def test_baseline_calculation():
    """Test baseline calculation for all metrics"""
    
    print("=" * 80)
    print("BASELINE CALCULATOR - LOCAL TEST")
    print("=" * 80)
    ...
    output_file = f"baseline_test_results_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
